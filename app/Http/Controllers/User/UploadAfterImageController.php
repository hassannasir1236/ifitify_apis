...
class UploadAfterImageController extends Controller
{
    /**
    ...
    public function __invoke(
        ...
        $request->validate([
            'after_image' => 'required|image|mimes:jpeg,png,jpg,gif|max:10240'
        ]);
        ...
        $data = ['progress_image_url' => 'progress_image/' . $name];
